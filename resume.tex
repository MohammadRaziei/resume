...
\small{
   ...
   Image, Natural Language, Audio and Generally Signal Processing, Processing.
    With studies in Communication Systems, Computer Engineering at Polytechnic
   of Tehran as Bachelor, and Biomedical Engineering at Sharif University as Master, I specialize
...
I started my activity at Hamrah Avval in the search engine team. My main areas of focus included web page analysis, artificial intelligence, web graph analysis, converting Python code to C++, and binding it to Python. In this process, I became familiar with DevOps skills and learned many software engineering principles.

\textbf{Key skills:} Qt, C++, Boost, CPython, Cython, Python, Web Analysis, AI, Graph Analysis, DevOps, Software Engineering, Code Optimization
