...
\textbf{Key skills:} Qt, C++, Boost, CPython, Cython, Python, Document Analysis, Parsing \& rendering HTML, NLP, Machine Learning, DevOps, docker, kubernetes, search engine optimization(CEO) features
