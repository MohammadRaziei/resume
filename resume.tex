...
\section{Overview}
\small{
	I'm Mohammad Raziei, passionate about Data Science,
   ...
   continuous learning.
% As a conversational AI developer with years of industry experience building natural language processing pipelines using deep learning, and machine learning, I seek a new challenging role to enhance my skills. I have a strong foundation in NLP techniques such as named entity recognition, sentiment analysis, intent detection, and text summarization. Furthermore, I am experienced in various NLP tasks such as question answering, question generation, and chatbots. In addition to technical expertise, 
I excel at collaborative problem-solving, communication, and learning new technologies, and I aim to leverage this well-rounded skillset and track record of shipped products to impact business objectives through innovative conversational solutions meaningfully.
}
%--------------------------------------------
%-----------EDUCATION-------------------------
...
\resumeItemScore{Computing Programming}{2020}
\resumeItemScore{Logic Circuits}{2020}
\resumeItemScore{Electromagnetics}{2020}
\resumeItemScore{Advanced Programming (AP)}{19.1919.19}
\resumeItemScore{Signals \& Systems}{18.4218.42}
\resumeItemScore{Foundation of Matrix and Linear Algebra}{18.818.8}
\resumeItemScore{Computer Architecture \& Microprocessors}{2020}
\resumeItemScore{Computer Networks}{17.217.2}
\resumeItemScore{Communication Systems}{17.2517.25}
\resumeItemListEnd{}
\end{multicols}
...
{Data Scientist - Senior Python and C++ developer}{Tehran, Iran}\\
...
\textbf{Key skills:} Qt, C++, Boost, CPython, Cython, Python, Document Analysis, Parsing \& rendering HTML, NLP, Machine Learning, DevOps, docker, kubernetes, search engine optimization(SEO) features

\resumeQuadHeading{Sunyar Company}{Jan 2021 -- Nov 2020}
{Lead of AI and Software Engineering}{Tehran, Iran}\\
...
\textbf{Key skills:} Qt, C++, Matlab, Python, Signal Processing, Communication, Modulation Recognition, monitoring, CUDA
...
% \resumeItemListStart{}
% \resumeItem{Qt, QMake, CMake}: For configuration of project, Graphics and etc.
% \resumeItem{STL, Boost libraries}: Writing algorithms with a combination of boost libraries and standard libraries (cpp17).
% \resumeItem{GNU Radio}: The main component of communication algorithms. we using this library.
% \resumeItem{ALGLIB}:  using this library for operations such as optimization and interpolation. For example, I used its interpolation capability to remove the baseline signal.
% \resumeItem{Armadillo \& Eigen \& libigl}:
% Armadillo and Eigen were both used in this project, being suitable for matrix and signal processing tasks. The libigl library was also a wrapper on Eigen, which helped simplify the translation from Matlab to C++.
% \resumeItemListEnd{}
% \vspace{-.5em}
